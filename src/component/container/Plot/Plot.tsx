    ...
    case 'growth1':
      contained =
        <div className={styles.plotContents}>
          ...
          {/* TODO: replace empty alts */}
          <img alt={''} className={styles.sprout1} src={sprout}/>
        </div>
      break
    case 'growth2':
      contained =
        <div className={styles.plotContents}>
          ...
          <img alt={''} className={styles.sprout2} src={sprout}/>
        </div>
      break
    case 'grown':
      contained =
        <div className={styles.plotContents}>
          ...
          <img alt={''} className={styles.sprout3} src={sprout}/>
        </div>
      break
    case 'with-starburst':
      contained =
        <DirectedDialog
          ...
          anchor={
            <div className={styles.plotContents}>
              ...
              <img alt={''} className={styles.sprout3} src={sprout}/>
              <img alt={''} className={styles.starburst} src={starburst}/>
            </div>
          }
    ...
    case 'protected':
      contained =
        <div className={styles.plotContents}>
          ...
          <img alt={''} className={styles.sprout3} src={sprout}/>
          <img alt={''} className={styles.fenceBackground} src={fenceBackground} />
          <img alt={''} className={styles.fenceForeground} src={fenceForeground} />
        </div>
      break
    case 'protected-tomato':
      contained =
        <div className={styles.plotContents}>
          <img alt={''} className={styles.tomatoPlant} src={tomatoPlant} />
          <img alt={''}
