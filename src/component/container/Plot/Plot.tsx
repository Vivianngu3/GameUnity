    ...
    case 'growth1':
      contained =
        <div className={styles.plotContents}>
          ...
          <img alt={'small sized sprout'} className={styles.sprout1} src={sprout}/>
        </div>
      break
    case 'growth2':
      contained =
        <div className={styles.plotContents}>
          ...
          <img alt={'medium sized sprout'} className={styles.sprout2} src={sprout}/>
        </div>
      break
    case 'grown':
      contained =
        <div className={styles.plotContents}>
          ...
          <img alt={'full sized sprout'} className={styles.sprout3} src={sprout}/>
        </div>
      break
    case 'with-starburst':
      contained =
        <div className={styles.plotContents}>
          ...
          <img alt={'full sized sprout'} className={styles.sprout3} src={sprout}/>
          <img alt={'golden background comic burst'} className={styles.starburst} src={starburst}/>
        </div>
      break
    case 'protected':
      contained =
        <div className={styles.plotContents}>
          ...
          <img alt={'full sized sprout'} className={styles.sprout3} src={sprout}/>
          <img alt={'back side of white fence'} className={styles.fenceBackground} src={fenceBackground} />
          <img alt={'front side of white fence'} className={styles.fenceForeground} src={fenceForeground} />
        </div>
      break
    case 'protected-tomato':
      contained =
        <div className={styles.plotContents}>
          <img alt={'fully grown plant with tomatoes'} className={styles.tomatoPlant} src={tomatoPlant} />
          <img alt={'back side of white fence'}
               onClick={() => {if (props.removeFence) props.removeFence()}}
               className={styles.fenceBackground} src={fenceBackground}
          />
          <img alt={'front side of white fence'}
               onClick={() => {if (props.removeFence) props.removeFence()}}
