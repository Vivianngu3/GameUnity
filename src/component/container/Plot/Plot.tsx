    ...
    case 'growth1':
      contained =
        <div className={styles.holeContainer}>
          ...
          <img className={styles.sprout1} src={sprout}/>
        </div>
      break
    case 'growth2':
      contained =
        <div className={styles.holeContainer}>
          ...
          <img className={styles.sprout2} src={sprout}/>
        </div>
      break
    case 'grown':
      contained =
        <div className={styles.holeContainer}>
          ...
          <img className={styles.sprout3} src={sprout}/>
        </div>
      break
    case 'with-starburst':
      contained =
        <div className={styles.holeContainer}>
          ...
          <img className={styles.sprout3} src={sprout}/>
          <img className={styles.starburst} src={starburst}/>
        </div>
      break
    case 'protected':
      contained =
