...
export default function PlotAnimation() {
  ...
  return (
    <div className={styles.soil} >
      <div className={styles.plotContents}>
        ...
        <img draggable={false} alt={'growing plant'} className={styles.animatedSprout} src={sprout}/>
        <img draggable={false} alt={'golden background comic burst'} className={styles.animatedStarburst} src={starburst}/>
      </div>
    </div>
  )
}